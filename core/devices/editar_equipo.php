...
<html lang="es">
<head>
  <title>Parque Informático - Editar Equipo</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <?php skeleton(); ?>
</head>
...
<div class="container-fluid"><br>
  ...
  <?php
    ...
    if($conn){
        ...
        $id = $_GET['id'];
        $oneDevice->formEditarDevice($oneDevice,$id,$conn,$db_basename);
...
<script type="text/javascript" src="lib_devices.js"></script>
