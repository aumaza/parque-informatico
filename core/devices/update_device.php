<?php include "../../connection/connection.php";
	  ...
	  if($conn){
	  	...
	  	if(($id == "") ||
	  		...
	  		$oneDevice->updateDevice($oneDevice,$id,$nombre_apellido,$patrimonio,$ip,$gateaway,$submask,$dns,$nro_oficina,$login_usuario,$sistema_operativo,$periscopio,$puesto_ubicacion,$mac_address,$conn,$db_basename);
	  	}
