...
<html lang="es">
<head>
  <title>Parque Informático - Listado de Pedidos de Soporte</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <?php skeleton(); ?>
</head>
...
<div class="container-fluid"><br>
  ...
  <?php
    ...
    if($conn){
        ...
        $oneSupport->supportsList($oneSupport,$device_id,$conn,$db_basename);
...
<script type="text/javascript" src="lib_support.js"></script>
